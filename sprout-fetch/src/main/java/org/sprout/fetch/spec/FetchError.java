...
public enum FetchError {
    ...
    FILESIZE_LOST_ERR(10, "FetchService the saved lost the real size error."),
    SAVESIZE_LESS_ERR(11, "FetchService the saved less than real size error."),
    SAVESIZE_MORE_ERR(12, "FetchService the saved more than real size error."),
